...
const funkcija = (karta) => {
  ...
  const imeProizvoda = karta.length;
  ...
  const sum = newArr.reduce((a, b) => a + b.ukupnaCena, shippingCost);
  return `You got ${imeProizvoda} in cart, shipping cost is ${shippingCost}, your total is ${sum}.`;
};
